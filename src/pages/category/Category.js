...
function Category() {
    ...
    useEffect(() => {
        ...
        } else if (buscar == '1' || buscar == '2' || buscar == '4'|| buscar == '3') {
    ...
    const menuCategoria = () => {
        return categorias.slice(0, 4).map(cate => (
          <li className="nav-item menuletra">
            <Link 
              onClick={() => { getBuscarCategoria(cate.id) }} 
              className="nav-link menuletra"
            >
              {cate.descricao}
            </Link>
          </li>
                ...
                <div className="row ">
                    ...
                    <div className="col-sm-12 col-lg-9 ladodireito ">
                        <div className="row justify-content-between ">
                            ...
                            <p className="text-left  produtoencoontrado col-lg-8"> Produtos Encontrados:</p>
