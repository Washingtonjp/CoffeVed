                                ...
                                <li className="nav-item-canvas dropdown">
                                    ...
                                    <div className="collapse" id="collapseExample">
                                        <div className="card card-body">
                                            <Link to="/category/1" className="dropdown-item">Frutas</Link>
                                            <Link to="/category/2" className="dropdown-item">Salgados</Link>
                                            <Link to="/category/3" className="dropdown-item" >Doces</Link>
                                            <Link to="/category/4" className="dropdown-item" >Cafes</Link>
                                        </div>
                                    </div>
                                </li>
                                <Link to="/category/novidades"><li className="nav-item">
                                    Novidades
                                </li></Link>
